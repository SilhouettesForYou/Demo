...
namespace Demo
{
    public class UIManager : MonoBehaviour
    {
        ...
        public static bool isStartUILoaded = false;
        public static string lastUIName = "";
        public static string lastLevelName = "";
        public static bool isLogin = false;
        public static int userImageID;
        ...
        {
            if (GameObject.FindGameObjectWithTag(SystemDefine.canvasTag) == null)
