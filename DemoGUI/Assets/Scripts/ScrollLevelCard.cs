...
namespace Demo
{
    public class ScrollLevelCard : BaseUI, IBeginDragHandler, IEndDragHandler
    {
        ...
        private float sensitivity = 0.55f;                          //灵敏度
        ...
        {
            pageIndex = (levelItems.childCount / pageCount) - 1;
        ...
        void Update()
        {
            if (!isDrag)
                scrollRect.horizontalNormalizedPosition =
                    Mathf.Lerp(scrollRect.horizontalNormalizedPosition, targetPos, Time.deltaTime * smooting);
        }
